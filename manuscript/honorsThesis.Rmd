...
The main effect of stimulus duration was, `r print_anova$full_result$encoding_time`. Mean accuracy in the 500 ms condition was `r mean(subset(subject_means, encoding_time == 500)$mean_correct)`, mean accuracy in the 1000 ms condition was `r mean(subset(subject_means, encoding_time == 1000)$mean_correct)`, and mean accuracy in the 2000 ms condition was `r `r mean(subset(subject_means, encoding_time == 2000)$mean_correct)``. 
