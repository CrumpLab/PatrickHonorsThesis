...
\hline
encoding\_stimulus\_time & encoding\_instruction & test\_condition & grp\_mean\_correct & sem\\
\hline
500 & F & exemplar & 0.5133333 & 0.0278474\\
\hline
500 & F & novel & 0.7200000 & 0.0353635\\
\hline
500 & R & exemplar & 0.5566667 & 0.0261223\\
\hline
500 & R & novel & 0.7100000 & 0.0435098\\
\hline
1000 & F & exemplar & 0.6333333 & 0.0399233\\
\hline
1000 & F & novel & 0.7633333 & 0.0337276\\
\hline
1000 & R & exemplar & 0.5600000 & 0.0337673\\
\hline
1000 & R & novel & 0.7066667 & 0.0371184\\
\hline
2000 & F & exemplar & 0.5566667 & 0.0294327\\
\hline
2000 & F & novel & 0.7500000 & 0.0302290\\
\hline
2000 & R & exemplar & 0.5733333 & 0.0248829\\
\hline
2000 & R & novel & 0.7666667 & 0.0413378\\
\hline
\end{tabular}

\includegraphics{honorsThesis_files/figure-latex/unnamed-chunk-1-1.pdf} \includegraphics{honorsThesis_files/figure-latex/unnamed-chunk-1-2.pdf} \includegraphics{honorsThesis_files/figure-latex/unnamed-chunk-1-3.pdf} \includegraphics{honorsThesis_files/figure-latex/unnamed-chunk-1-4.pdf} \includegraphics{honorsThesis_files/figure-latex/unnamed-chunk-1-5.pdf} \includegraphics{honorsThesis_files/figure-latex/unnamed-chunk-1-6.pdf} \includegraphics{honorsThesis_files/figure-latex/unnamed-chunk-1-7.pdf}
...
The main effect of cue instruction condition was, \(F(1, 29) = 0.59\), \(\mathit{MSE} = 0.02\), \(p = .448\), \(\hat{\eta}^2_G = .001\). Mean accuracy in the remember condition was 0.65, and mean accuracy in the forget condition was 0.66.

The main effect of test condition was, \(F(1, 29) = 67.82\), \(\mathit{MSE} = 0.04\), \(p < .001\), \(\hat{\eta}^2_G = .177\). Mean accuracy in the novel test condition was 0.74, and mean accuracy in the exemplar test condition was 0.57.

The main effect of stimulus duration was, \(F(2, 58) = 2.78\), \(\mathit{MSE} = 0.02\), \(p = .070\), \(\hat{\eta}^2_G = .010\). Mean accuracy in the 500 ms condition was 0.62, mean accuracy in the 1000 ms condition was 0.67, and mean accuracy in the 2000 ms condition was \texttt{r\ 0.66}.

The two-way interaction between encoding instruction and test condition was, \(F(1, 29) = 0.12\), \(\mathit{MSE} = 0.03\), \(p = .728\), \(\hat{\eta}^2_G = .000\). The two-way interaction between encoding instruction and stimulus duration was, . The two-way interaction between test condition and stimulus duration was, . Finally, the three-way interaction was, .
